...
_COMPILED_CACHE: dict[tuple[int, int, int, int, int, int, int], "Compiled"] = {}
...
def build_xclbin(
    ...
    key = (hidden, ffn, down_m, m, k, act, n_cores)
    ...
    compiled = Compiled(hidden, ffn, down_m, m, k, act, n_cores, xclbin,
